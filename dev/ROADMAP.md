...
## v0.2.0 -- k-means training + assignment + IVF-Flat search (THE HARD PART, NOT DEFERRED)
...
## v0.3.0 -- probe tuning + retrain + filtered cluster search
...
## v0.4.0 -- IVF-PQ via iqdb-quantize + feature freeze
...
## v0.5.0 -- recall validation at scale + API freeze
